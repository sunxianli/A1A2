...
%产生邻接矩阵
      ...
      temPro=rand(1,1);
        ...
        temPro=rand(1,1);
%         temPro=yita*power(((power(1,-Exponent_A+1)-power(minActivity,-Exponent_A+1))*t2+power(minActivity,-Exponent_A+1)),1/(-Exponent_A+1));      
...
%    for i=1:N
% %       te =rand(1,1);
% %    temPro=yita*power(((power(1,-Exponent_A+1)-power(minActivity,-Exponent_A+1))*te+power(minActivity,-Exponent_A+1)),1/(-Exponent_A+1));    
