...
grid off;
 set(gca,'Fontsize',15);
plot(xzhou,BETA_G','-o','color',[77/256 133/256 189/256]);
plot(xzhou,BETA_A1','-^','color',[247/256 144/256 61/256]);
plot(xzhou,BETA_A2','-v','color',[89/256 169/256 90/256]);
