...
%求阈值的图像时，当系统到达稳态时，G的值为0.所以A1=A1S
 ...
 %求阈值
    ...
    Ba=sum(BActivity)/N;
    Ba2=Ba2/N;
    x=(1-(1-gama1)* rhoA1-(1-gama2(l1))* rhoA2)*(Ba2-(1-gama1)*Theta_b2A1-(1-gama2(l1))*Theta_b2A2);
    EH=sqrt(x)+Ba-(1-gama1)*Theta_bA1-(1-gama2(l1))*Theta_bA2;
...
h=legend('$\gamma_1$=1,$\gamma_2$=0','$\gamma_1$=1,$\gamma_2$=0.5','$\gamma_1$=1,$\gamma_2$=1');
