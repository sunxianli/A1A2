...
delta1=0.01;
delta2=0.01;
gama2=1;%衰减系数，当其为0时，知道信息的个体是完全免疫的。在这里若等于1，
gama1=[1,1.5,2];
mun=length(gama1);
ma=5;%AD网络每次连接的边数
mb=5;
...
%求阈值的图像时，当系统到达稳态时，G的值为0.所以A1=A1S
 ...
 %求阈值
    ...
    Ba=sum(BActivity)/N;
    Ba2=Ba2/N;
    x=(1-(1-gama1(l1))* rhoA1-(1-gama2)* rhoA2)*(Ba2-(1-gama1(l1))*Theta_b2A1-(1-gama2)*Theta_b2A2);
    EH=sqrt(x)+Ba-(1-gama1(l1))*Theta_bA1-(1-gama2)*Theta_bA2;
...
h=legend('$\gamma_1$=1,$\gamma_2$=1','$\gamma_1$=1.5,$\gamma_2$=1','$\gamma_1$=2,$\gamma_2$=1');
