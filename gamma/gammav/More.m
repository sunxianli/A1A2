...
delta1=0.5;
delta2=0.5;
% gama1=[2,1.5,1];%衰减系数，当其为0时，知道信息的个体是完全免疫的。在这里若等于1，
% gama2=[1,0.5,0];
...
grid off;
set(gca,'Fontsize',15);
plot(xzhou,beta_num(1,:));
plot(xzhou,beta_num(2,:));
plot(xzhou,beta_num(3,:));
plot(xzhou,beta_num(4,:));
plot(xzhou,beta_num(5,:));
plot(xzhou,beta_num(6,:));
