...
grid off;
set(gca,'Fontsize',15);
plot(xzhou,rhoG_num(1,:)','-o','color',[77/256 133/256 189/256],'MarkerFaceColor',[77/256 133/256 189/256]);
...
xlabel('$\gamma_1$','FontSize',15);ylabel('$\rho^G$','FontSize',15);   % 閸ф劖鐖ｆ潪纾嬓掗柌锟?
h=legend('$\lambda_1=0.8,\lambda_2=0.5$','$$\lambda_1=0.5,\lambda_2=0.5$','$$\lambda_1=0.5,\lambda_2=0.8$');
set(h,'Interpreter','latex','FontSize',15)%,
% save('rhoG_num.mat','rhoG_num')
% saveas(gcf, 'rhoG_num.fig')
